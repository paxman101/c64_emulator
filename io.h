...
private:
    ...
    const std::unordered_map<SDL_Scancode, std::pair<uint8_t, uint8_t>> key_map = {
            {SDL_SCANCODE_ESCAPE, {7,7}},   {SDL_SCANCODE_Q, {7,6}},           {SDL_SCANCODE_APPLICATION, {7,5}}, {SDL_SCANCODE_SPACE, {7,4}},  {SDL_SCANCODE_2, {7,3}},     {SDL_SCANCODE_LCTRL, {7,2}},     {SDL_SCANCODE_LEFT, {7,1}},         {SDL_SCANCODE_1, {7,0}},
            {SDL_SCANCODE_SLASH, {6,7}},    {SDL_SCANCODE_UP, {6,6}},          {SDL_SCANCODE_APOSTROPHE, {6,5}},  {SDL_SCANCODE_RSHIFT, {6,4}}, {SDL_SCANCODE_HOME, {6,3}},  {SDL_SCANCODE_SEMICOLON, {6,2}}, {SDL_SCANCODE_RIGHTBRACKET, {6,1}}, {SDL_SCANCODE_PAUSE, {6,0}},
            {SDL_SCANCODE_COMMA, {5,7}},    {SDL_SCANCODE_LEFTBRACKET, {5,6}}, {SDL_SCANCODE_SEMICOLON, {5,5}},   {SDL_SCANCODE_PERIOD, {5,4}}, {SDL_SCANCODE_MINUS, {5,3}}, {SDL_SCANCODE_L, {5,2}},         {SDL_SCANCODE_P, {5,1}},            {SDL_SCANCODE_EQUALS, {5,0}},
